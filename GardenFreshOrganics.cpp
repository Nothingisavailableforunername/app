...
// Employee Functions
void inventoryToSale(int &index, int &inventoryIndex, int &profit);
            ...
            while (!exitLoop)
            {
                ...
                else if (result1 == "employee")
                {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        inventoryToSale(index, inventoryIndex, profit);
                        break;
                    case 5:
                        viewItems(itemIndex);
                        break;
...
void inventoryToSale(int &index, int &inventoryIndex, int &profit)
{
    ...
    {
        int sr = stoi(strSr), price = stoi(strPrice);
            ...
            for (int i = 0; i < inventoryIndex; i++)
            {
                if (sr - 1 == i)
                {
                    ...
                    for (int j = i; j < inventoryIndex; j++)
                    {
                        ...
                        inventoryPrice[i] = inventoryPrice[i + 1];
